...
| API | `CIRRUS_API_MAX_MULTIPART_UPLOAD_SIZE_BYTES`, `CIRRUS_API_MAX_UPLOAD_METADATA_SIZE_BYTES`, `CIRRUS_API_RATE_LIMIT_PERMIT_COUNT`, `CIRRUS_API_RATE_LIMIT_WINDOW_SECONDS` |
